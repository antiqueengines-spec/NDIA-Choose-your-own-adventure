...
export const extraMocks: Record<string, MockExchange> = {
    ...
    request: {
      bulk_payment_request: [
        ...
        },
        {
          ...
          end_date: '2024-02-01',
          product_category_item: '04_104_0125_6_1',
          ref_doc_no: '73--a0bOZ000000PBN1YAO--229539--1',
          quantity: 2,
          hours: '2',
          unit_price: 65.47,
          tax_code: 'P2',
  ...
  kai_batch_open: {
    ...
    plainEnglish:
      'Bulk finish: Maya (SAP) and Sam (PACE) are Payment Pending. The third PACE line is OPEN — claim_number 0, empty claim_status — held until endorsement or timeout.',
    responseParsed: {
      ...
      rows: [
        ['Maya Chen', 'SAP', '10504001', '$135.12', 'Payment Pending (4)'],
        ['Sam Okonkwo', 'PACE', '10504002', '$193.99', 'Payment Pending (4)'],
        ['431015452', 'PACE', '0', '$130.94', 'OPEN (held)'],
      ],
      notes: [
  ...
  kai_bulk_report_paid: {
    ...
    plainEnglish:
      'Overnight BULK_CLAIM_REPORT: previously pending lines now Paid (claim_status 41) with paid_date and clearing numbers. OPEN lines that were never endorsed do not appear as Paid.',
    responseParsed: {
      title: 'Bulk Claim Report — Paid',
      summary: 'Overnight webhook for kai-mixed-week.csv · claim_status 41',
      stats: [
        { label: 'Paid lines', value: '2' },
        { label: 'Total paid', value: '$329.11' },
        { label: 'Paid date', value: '29 Jul 2026' },
      ],
      columns: ['Participant', 'Claim #', 'Amount', 'Status', 'Clearing #'],
      rows: [
        ['Maya Chen', '10504001', '$135.12', 'Paid (41)', '7800001201'],
        ['Sam Okonkwo', '10504002', '$193.99', 'Paid (41)', '7800001202'],
      ],
      notes: [
        'OPEN / unendorsed PACE lines remain held until myplace approval, rejection, or system timeout — they will not show as Paid here.',
      ],
    },
  },
}
